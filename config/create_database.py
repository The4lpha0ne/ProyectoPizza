...
def create_database(db_file):
    ...
    conn.execute ("CREATE TABLE Pizza (IdPizza INT NOT NULL,Nombre varchar(25) not null, Tamano varchar(10) NOT NULL, Precio FLOAT DEFAULT NULL, PRIMARY KEY(Nombre,Tamano))")
    ...
    conn.execute("INSERT INTO Pizza VALUES (11344,'Barbacoa','Grande',15),(24545,'Barbacoa','Mediana',12),(234334,'Barbacoa','Pequena',7),(33443,'Margarita','Grande',15),(343434,'Margarita','Mediana',12),(9848,'Margarita','Pequena',7),(1039,'Marinera','Grande',15),(1394,'Marinera','Mediana',12),(10234,'Marinera','Pequena',7)")
